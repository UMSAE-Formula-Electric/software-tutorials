1.  Follow steps 2 → 6 of the HAL USART tutorial (Tutoral 2) to set up a new CubeMX
    project. This time we are going to enable UART

    - To do this, set the mode from "Synchronous" to "Asynchronous"
...
4.  First you’ll need to write the function `HAL_UART_Receive_IT()`
    ...
    - Use some of the following parameters when "enabling" this
        function

    - Write the function in the "USER CODE BEGIN 2" comment block of
        the code
