...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
	uint8_t msg[] = "Welcome to Software!!! -> Press 't' to toggle led\r\n"; // msg
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  HAL_UART_Transmit(&huart2, &msg, msg_size, 100);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart){
	if(recvd_data == 't'){
		  ...
		  HAL_UART_Transmit(huart,&msg, &msg_size, 100);
	}
	//Restarting the receiving after each 't'
